...
\item 
bool \mbox{\hyperlink{state__machine_8cpp_a7b41b5ac885385d5a2f18273038644e9}{not\+\_\+moving}} = true
...
\index{state\_machine.cpp@{state\_machine.cpp}!not\_moving@{not\_moving}}
\index{not\_moving@{not\_moving}!state\_machine.cpp@{state\_machine.cpp}}
\doxysubsubsection{\texorpdfstring{not\_moving}{not\_moving}}
{\footnotesize\ttfamily bool not\+\_\+moving = true}
